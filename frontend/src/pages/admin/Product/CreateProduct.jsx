  ...
  const validateForm = () => {
    ...
    if (!formData.price) {
      ...
      if (!numberRegex.test(formData.price)) {
        newErrors.price =
          "Giá phải là số, không chứa chữ cái hoặc ký tự đặc biệt.";
        isValid = false;
    ...
    if (!formData.quantity) {
      ...
      if (!numberRegex.test(formData.quantity)) {
    ...
    if (!formData.target) {
      newErrors.target = "Vui lòng chọn đối tượng sử dụng.";
      isValid = false;
    }
    ...
    if (!selectedFile) {
      newErrors.image = "Vui lòng chọn hình ảnh cho sản phẩm.";
      isValid = false;
    }
      ...
      <form className="create-form" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            onChange={handleChange}
            className={errors.detail_desc ? "input-error" : ""}
            style={{
              padding: "10px",
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input
              ...
              className={errors.image ? "file-input input-error" : "file-input"}
            />
            {errors.image && (
